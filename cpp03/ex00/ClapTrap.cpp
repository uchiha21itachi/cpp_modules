...
ClapTrap & ClapTrap::operator = (const ClapTrap & b)
{
    ...
    std::cout << "(Copy=Clap)\t All the attributes are infused in ClapTrap " << this->_name << 
...
void ClapTrap::attack(const std::string& target)
{
    ...
    {
        std::cout << "Claptrap " << this->_name << " Wants to attack " << target << std::endl;
        std::cout << "Cannot attack No EP left..\n\n" << std::endl;
    }
}
